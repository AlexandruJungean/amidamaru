    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert prose-zinc max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-white">1. Ce sunt cookie-urile?</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-white">2. Cookie-uri utilizate pe acest website</h2>
            
            <div className="space-y-6 mt-4">
              <div className="p-4 bg-zinc-900 rounded-lg border border-zinc-800">
                <h3 className="text-lg font-bold text-white mb-2">Cookie-uri esențiale</h3>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-zinc-700">
                      <th className="text-left py-2 text-zinc-300">Nume</th>
                      <th className="text-left py-2 text-zinc-300">Scop</th>
                      <th className="text-left py-2 text-zinc-300">Durată</th>
                    </tr>
                  </thead>
              ...
              <div className="p-4 bg-zinc-900 rounded-lg border border-zinc-800">
                <h3 className="text-lg font-bold text-white mb-2">Cookie-uri terțe părți</h3>
                <p className="text-zinc-400 text-sm mb-2">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-zinc-700">
                      <th className="text-left py-2 text-zinc-300">Serviciu</th>
                      <th className="text-left py-2 text-zinc-300">Scop</th>
                      <th className="text-left py-2 text-zinc-300">Mai multe informații</th>
                    </tr>
                  </thead>
                  <tbody className="text-zinc-400">
                    <tr>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-white">3. Cum să gestionați cookie-urile</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-white">4. Consimțământ</h2>
            <p className="text-zinc-400">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-white">6. Modificări</h2>
            <p className="text-zinc-400">
