          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <div className="relative">
              <button
                ...
                aria-label={currentLanguageInfo.name}
              ...
              >
                <FlagImage flag={currentLanguageInfo.flag} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-slide-in-right">
            ...
            <p className="text-xl text-[var(--red-dark)] font-medium mb-4">
              {t('about.subtitle')}
            </p>
    ...
    <section id="fleet" className="py-24 bg-zinc-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 flex flex-wrap justify-center items-center gap-12">
          <div className="text-2xl font-bold tracking-widest text-zinc-700">VOLVO</div>
          <div className="text-2xl font-bold tracking-widest text-zinc-700">IVECO</div>
          <div className="text-2xl font-bold tracking-widest text-zinc-700">EURO 6</div>
        </div>
      </div>
    </section>
  );
          ...
          <div>
            ...
            <div className="space-y-6">
              {companyInfo.map((info, index) => (
                ...
                >
                  <span className="text-zinc-700 font-medium min-w-[140px]">{info.label}:</span>
            ...
            <div className="mt-8 flex items-center gap-4 p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
              ...
              <span className="text-[var(--blue-dark)] font-medium">EU Licensed Transport Operator</span>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <a
                ...
                className="group flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-zinc-200 hover:border-[var(--blue-dark)] transition-all"
              >
                ...
                <span className="text-[var(--blue-dark)] text-sm font-medium">Facebook</span>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-zinc-200">
              <p className="text-zinc-600 text-xs">CUI: RO18556425</p>
              <p className="text-zinc-600 text-xs">Reg. Com.: J02/623/2006</p>
            </div>
          </div>
        </div>
      </div>
